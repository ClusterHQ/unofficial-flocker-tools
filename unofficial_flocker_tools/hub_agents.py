...
def report_completion(result, public_ip, message="Completed volume hub catalog agents install for"):
...
def main(reactor, configFile):
    ...
    installs = [c.runSSHAsync(control_ip, install_command)]

    for node in c.config["agent_nodes"]:
        installs.append(c.runSSHAsync(node["public"], install_command))
